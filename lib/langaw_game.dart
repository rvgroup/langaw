...
import 'package:langaw/components/credits_button.dart';
import 'package:langaw/components/drooler_fly.dart';
import 'package:langaw/components/fly.dart';
import 'package:langaw/components/help_button.dart';
import 'package:langaw/components/highscore_display.dart';
...
import 'package:langaw/components/music_button.dart';
import 'package:langaw/components/score_display.dart';
import 'package:langaw/components/sound_button.dart';
import 'package:langaw/components/start_button.dart';
import 'package:langaw/controllers/spawner.dart';
import 'package:langaw/view.dart';
import 'package:langaw/views/credits_view.dart';
import 'package:langaw/views/help_view.dart';
import 'package:langaw/views/home_view.dart';
import 'package:langaw/views/lost_view.dart';
...
class LangawGame extends Game {
  ...
  void spawnFly() {
    ...
    double y =
        (rnd!.nextDouble() * (screenSize!.height - (tileSize! * 2.025))) +
            (tileSize! * 1.5);
